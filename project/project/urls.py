...
urlpatterns = patterns('',
    ...
    url(r'^albums/(?P<album_id>([0-9a-zA-Z])+)/delete$', 'photoalbum.handlers.album_handlers.albumdeleteHandler'),
    url(r'^albums/(?P<album_id>([0-9a-zA-Z])+)/modify', 'photoalbum.handlers.album_handlers.albummodifyHandler'),
    url(r'^albums/(?P<album_id>([0-9a-zA-Z])+)/(?P<slide_id>([0-9])+)/$', 'photoalbum.handlers.album_handlers.slideitemHandler'),
    url(r'^albums/(?P<album_id>([0-9a-zA-Z])+)/(?P<slide_id>([0-9])+)/delete$', 'photoalbum.handlers.album_handlers.slidedeleteHandler'),
    ...
    url(r'^albums/(?P<album_id>([0-9a-zA-Z])+)/(?P<slide_id>([0-9])+)/(?P<photo_id>([0-9])+)/modify$', 'photoalbum.handlers.album_handlers.slidephotomodifyHandler'),
    # Order
    ...
    url(r'^orders/(?P<order_id>([0-9])+)/delete$', 'photoalbum.handlers.order_handlers.orderitemdeleteHandler'),
)
